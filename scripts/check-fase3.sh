...
hasi 'onda 1'                              && ok "recorte é a onda 1"               || err "sem recorte de onda 1"
hasi 'writing-plans'                       && ok "usa writing-plans (não Goal) "    || err "não usa writing-plans"
hasi 'executing-plans'                     && ok "usa executing-plans na onda 1"    || err "não usa executing-plans"
hasi 'Como continuar depois'               && ok "ondas 2+ ficam no plano"          || err "sem seção Como continuar depois"
